package com.zmax.common.utils.image;
...
import com.zmax.common.utils.image.ImageUtils.Position;
...
public class AverageImageScale {
	 ...
	 * @throws IOException
	 */
	public static void resizeFixWithWidth(File srcFile, File destFile, int boxWidth) throws IOException {
		BufferedImage srcImgBuff = ImageIO.read(srcFile);
		int width = srcImgBuff.getWidth();
		int height = srcImgBuff.getHeight();
		int boxHeight=height*boxWidth/width;
	 ...
	 * @throws IOException
	 */
	public static void resizeFixWithHeight(File srcFile, File destFile, int boxHeight) throws IOException {
		BufferedImage srcImgBuff = ImageIO.read(srcFile);
		int width = srcImgBuff.getWidth();
		int height = srcImgBuff.getHeight();
