...
@Entity
@Table(name = "cashmember_stati_day")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class CashmemberStatiDay extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "会员现金日统计";
	 ...
	 * @param _this
	 */
	public void makedefault(CashmemberStatiDay _this){
		_this.gmtCreate=new Date();
		_this.num=0;
		_this.nstart=0;
		_this.nend=0;
	}
	public CashmemberStatiDay(){
		makedefault(this);
	}
	public CashmemberStatiDay(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public CashmemberStatiDay(Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public CashmemberStatiDay(Integer id ,Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public CashmemberStatiDay(Integer id ,Date gmtCreate ,Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof CashmemberStatiDay == false) return false;
		if(this == obj) return true;
		CashmemberStatiDay other = (CashmemberStatiDay)obj;
