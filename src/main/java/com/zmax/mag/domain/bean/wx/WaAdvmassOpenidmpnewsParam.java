...
public class WaAdvmassOpenidmpnewsParam extends BaseEntity{
	 ...
	 * @param _this
	 */
	public void makedefault(WaAdvmassOpenidmpnewsParam _this){
		_this.msgtype="mpnews";
	}
	public WaAdvmassOpenidmpnewsParam(){
		makedefault(this);
	}
	/**
	 * 不包括自动变量的构造
	...
	* @param notuse String 没用
	 */
	public WaAdvmassOpenidmpnewsParam(String msgtype ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public WaAdvmassOpenidmpnewsParam(List<String> touser ,WaAdvmassMpnews mpnews ,String msgtype ,String notuse,Object notuse2) {
		super();
		this.touser = touser;
		this.mpnews = mpnews;
		this.msgtype = msgtype;
...
WaAdvmassOpenidmpnewsParam waAdvmassOpenidmpnewsParam = new WaAdvmassOpenidmpnewsParam(
