...
@Entity
@Table(name = "orderr_questionview")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class OrderrQuestionview extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "订单之一对一问题观看";
	 ...
	 * @param _this
	 */
	public void makedefault(OrderrQuestionview _this){
		_this.gmtCreate=new Date();
		_this.status=0;
		_this.itypePay=0;
		_this.price=0.0;
	}
	public OrderrQuestionview(){
		makedefault(this);
	}
	public OrderrQuestionview(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public OrderrQuestionview(Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,Integer questionId ,String notuse) {
		super();
		this.gmtPay = gmtPay;
		this.status = status;
	...
	* @param notuse String 没用
	 */
	public OrderrQuestionview(Integer id ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer questionId ,String title ,Double price ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public OrderrQuestionview(Integer id ,Date gmtCreate ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer questionId ,String title ,Double price ,WaJsapiPaymentParam paywxh5 ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof OrderrQuestionview == false) return false;
		if(this == obj) return true;
		OrderrQuestionview other = (OrderrQuestionview)obj;
