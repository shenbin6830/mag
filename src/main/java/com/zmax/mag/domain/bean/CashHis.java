...
public class CashHis extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "现金流水";
	...
	/**类型 Integer default=0 对会员来说正是得现金，负是失现金 map={'-2':'购买积分','-1':'提现','1':'现金充值','2':'积分变现','3':'支付宝充值','4':'微信充值'}*/
	@Max(99999999999L)
	
	private Integer otype = 0;
	/**数量 Integer default=0 单位分，有正负，正是得，负是失 */
	@Max(99999999999L)
	 ...
	 * @param _this
	 */
	public void makedefault(CashHis _this){
	 ...
	 * @param otype Integer 类型 default=0 对会员来说正是得现金，负是失现金 {'-2':'购买积分','-1':'提现','1':'现金充值','2':'积分变现','3':'支付宝充值','4':'微信充值'}
	 * @param num Integer 数量 default=0 单位分，有正负，正是得，负是失 
	 * @param oid Integer 订单的id default=0 根据类型，指向不同的订单表 
	 * @param cmemo String 备注说明   
	* @param notuse String 没用
	 */
	public CashHis(Integer memberId ,Integer otype ,Integer num ,Integer oid ,String cmemo ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public CashHis(Integer id ,Integer memberId ,Integer otype ,Integer num ,Integer oid ,String cmemo ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public CashHis(Integer id ,Date gmtCreate ,Integer memberId ,Integer otype ,Integer num ,Integer oid ,String cmemo ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	/**获取类型 对会员来说正是得现金，负是失现金 {'-2':'购买积分','-1':'提现','1':'现金充值','2':'积分变现','3':'支付宝充值','4':'微信充值'}*/
	...
	/**设置类型 对会员来说正是得现金，负是失现金 {'-2':'购买积分','-1':'提现','1':'现金充值','2':'积分变现','3':'支付宝充值','4':'微信充值'}*/

	public void setOtype(Integer value) {
		this.otype = value;
	}
	/**获取数量 单位分，有正负，正是得，负是失 */
	...
	public boolean equals(Object obj) {
		if(obj instanceof CashHis == false) return false;
		if(this == obj) return true;
		CashHis other = (CashHis)obj;
