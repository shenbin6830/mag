...
@Entity
@Table(name = "cashmember_stati_month")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class CashmemberStatiMonth extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "会员现金月统计";
	 ...
	 * @param _this
	 */
	public void makedefault(CashmemberStatiMonth _this){
		_this.gmtCreate=new Date();
		_this.num=0;
		_this.nstart=0;
		_this.nend=0;
	}
	public CashmemberStatiMonth(){
		makedefault(this);
	}
	public CashmemberStatiMonth(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public CashmemberStatiMonth(Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public CashmemberStatiMonth(Integer id ,Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public CashmemberStatiMonth(Integer id ,Date gmtCreate ,Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof CashmemberStatiMonth == false) return false;
		if(this == obj) return true;
		CashmemberStatiMonth other = (CashmemberStatiMonth)obj;
