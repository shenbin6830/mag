...
public class WaAdvmassOpenidvoiceParam extends BaseEntity{
	 ...
	 * @param _this
	 */
	public void makedefault(WaAdvmassOpenidvoiceParam _this){
		_this.msgtype="voice";
	}
	public WaAdvmassOpenidvoiceParam(){
		makedefault(this);
	}
	/**
	 * 不包括自动变量的构造
	...
	* @param notuse String 没用
	 */
	public WaAdvmassOpenidvoiceParam(String msgtype ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public WaAdvmassOpenidvoiceParam(List<String> touser ,WaEntityVoice voice ,String msgtype ,String notuse,Object notuse2) {
		super();
		this.touser = touser;
		this.voice = voice;
		this.msgtype = msgtype;
...
WaAdvmassOpenidvoiceParam waAdvmassOpenidvoiceParam = new WaAdvmassOpenidvoiceParam(
