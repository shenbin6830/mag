...
@Entity
@Table(name = "expmember_stati_month")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class ExpmemberStatiMonth extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "会员经验月统计";
	 ...
	 * @param _this
	 */
	public void makedefault(ExpmemberStatiMonth _this){
		_this.gmtCreate=new Date();
		_this.num=0;
		_this.nstart=0;
		_this.nend=0;
	}
	public ExpmemberStatiMonth(){
		makedefault(this);
	}
	public ExpmemberStatiMonth(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public ExpmemberStatiMonth(Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public ExpmemberStatiMonth(Integer id ,Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public ExpmemberStatiMonth(Integer id ,Date gmtCreate ,Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof ExpmemberStatiMonth == false) return false;
		if(this == obj) return true;
		ExpmemberStatiMonth other = (ExpmemberStatiMonth)obj;
