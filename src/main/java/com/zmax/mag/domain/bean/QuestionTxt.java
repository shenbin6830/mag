...
@Entity
@Table(name = "question_txt")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class QuestionTxt extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "一对一问题回答";
	 ...
	 * @param _this
	 */
	public void makedefault(QuestionTxt _this){
	}
	public QuestionTxt(){
		makedefault(this);
	}
	public QuestionTxt(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public QuestionTxt(String answer ,String notuse) {
		super();
		this.answer = answer;
	}
	/**
	...
	* @param notuse String 没用
	 */
	public QuestionTxt(Integer id ,String answer ,String notuse) {
		super();
		this.id = id;
		this.answer = answer;
	}
	...
	* @param notuse String 没用
	 */
	public QuestionTxt(Integer id ,String answer ,String notuse,Object notuse2) {
		super();
		this.id = id;
		this.answer = answer;
	}
	...
	/**Question - idQuestionObj*/
	private Question idQuestionObj;
	/**获取 Question - idQuestionObj*/
	@Transient
	
	public Question getIdQuestionObj() {
		return idQuestionObj;
	}
	/**设置 Question - 问题Obj*/
	public void setIdQuestionObj(Question value) {
		this.idQuestionObj=value;
	}
	/**问题Stringid*/
	...
	public void makeNullObj(){
		...
		this.idQuestionObj=null; //Question
	}
	/**
	 * 非常严格的检查对象，不能空不能0
	...
	public boolean equals(Object obj) {
		if(obj instanceof QuestionTxt == false) return false;
		if(this == obj) return true;
		QuestionTxt other = (QuestionTxt)obj;
	...
	public String toJsonNotshow1(){
		String[] excludesProperties={"myname","mynameid","idString","idQuestionObj","idStringid","obj1","obj2","obj3","obj4","obj5","obj1","obj1","obj2","obj2","obj3","obj3","null"};
		String ret=JsonUtilAli.toJSONString(this, null, excludesProperties);
		return ret;
	}
	/**
