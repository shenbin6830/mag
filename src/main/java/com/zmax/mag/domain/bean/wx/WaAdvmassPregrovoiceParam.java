...
public class WaAdvmassPregrovoiceParam extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "根据openid进行群发之语音";
	 ...
	 * @param _this
	 */
	public void makedefault(WaAdvmassPregrovoiceParam _this){
		_this.msgtype="voice";
	}
	public WaAdvmassPregrovoiceParam(){
		makedefault(this);
	}
	/**
	 * 不包括自动变量的构造
	...
	* @param notuse String 没用
	 */
	public WaAdvmassPregrovoiceParam(String touser ,String msgtype ,String notuse) {
		super();
		this.touser = touser;
	 ...
	 * 全部数据的构造，包括了对象字段
	 * @param touser String 填写图文消息的接收者，  填写图文消息的接收者，一串OpenID列表，OpenID最少个，最多10000个 
	 * @param voice String 语音   
	 * @param msgtype String 群发的消息类型 default=voice 群发的消息类型，图文消息为mpnews，文本消息为text，语音为voice，音乐为music，图片为image，视频为video 
	* @param notuse String 没用
	 */
	public WaAdvmassPregrovoiceParam(String touser ,WaEntityVoice voice ,String msgtype ,String notuse,Object notuse2) {
		super();
		this.touser = touser;
		this.voice = voice;
		this.msgtype = msgtype;
...
/*
//精简构造 根据openid进行群发之语音
WaAdvmassPregrovoiceParam waAdvmassPregrovoiceParam = new WaAdvmassPregrovoiceParam(
