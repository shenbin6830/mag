...
@Entity
@Table(name = "quick_add")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class QuickAdd extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "抢答之追加";
	 ...
	 * @param _this
	 */
	public void makedefault(QuickAdd _this){
	...
	public QuickAdd(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	 * 精简版构造，在创建提交数据库时应该使用saveCreate
	 * @param quickId Integer 抢答   
	 * @param memberQu Integer 提问者 default=0  
	 * @param memberAn Integer 回答者 default=0  
	 * @param qa String 内容   
	* @param notuse String 没用
	 */
	public QuickAdd(Integer quickId ,Integer memberQu ,Integer memberAn ,String qa ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public QuickAdd(Integer id ,Date gmtModified ,Integer quickId ,Integer memberQu ,Integer memberAn ,String qa ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public QuickAdd(Integer id ,Date gmtCreate ,Date gmtModified ,Integer quickId ,Integer memberQu ,Integer memberAn ,String qa ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof QuickAdd == false) return false;
		if(this == obj) return true;
		QuickAdd other = (QuickAdd)obj;
	...
	public String toJsonNotshow1(){
		String[] excludesProperties={"myname","mynameid","gmtCreateString","gmtModifiedString","quickIdString","quickIdQuickObj","quickIdStringid","memberQuString","memberQuMemberObj","memberQuStringid","memberAnString","memberAnMemberObj","memberAnStringid","obj1","obj2","obj3","obj4","obj5","obj1","obj1","obj2","obj2","obj3","obj3","null"};
		String ret=JsonUtilAli.toJSONString(this, null, excludesProperties);
		return ret;
	}
	/**
