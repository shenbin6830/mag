...
@Entity
@Table(name = "orderr_quickview_finished")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class OrderrQuickviewFinished extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "订单之抢答问题观看归档";
	 ...
	 * @param _this
	 */
	public void makedefault(OrderrQuickviewFinished _this){
		_this.gmtCreate=new Date();
		_this.status=0;
		_this.itypePay=0;
		_this.price=0.0;
	}
	public OrderrQuickviewFinished(){
		makedefault(this);
	}
	public OrderrQuickviewFinished(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	 ...
	 * @param quickId Integer 抢答问题ID   
	* @param notuse String 没用
	 */
	public OrderrQuickviewFinished(Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,Integer quickId ,String notuse) {
		super();
		this.gmtPay = gmtPay;
		this.status = status;
	...
	* @param notuse String 没用
	 */
	public OrderrQuickviewFinished(Integer id ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer quickId ,String title ,Double price ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public OrderrQuickviewFinished(Integer id ,Date gmtCreate ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer quickId ,String title ,Double price ,WaJsapiPaymentParam paywxh5 ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof OrderrQuickviewFinished == false) return false;
		if(this == obj) return true;
		OrderrQuickviewFinished other = (OrderrQuickviewFinished)obj;
	...
	public String toJsonNotshow1(){
		String[] excludesProperties={"myname","mynameid","gmtCreateString","gmtPayString","statusString","statusMap","itypePayString","itypePayMap","memberIdString","memberIdMemberObj","memberIdStringid","quickIdString","quickIdQuickObj","quickIdStringid","obj1","obj2","obj3","obj4","obj5","obj1","obj1","obj2","obj2","obj3","obj3","null"};
		String ret=JsonUtilAli.toJSONString(this, null, excludesProperties);
		return ret;
	}
	/**
