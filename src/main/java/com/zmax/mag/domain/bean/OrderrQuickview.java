...
@Entity
@Table(name = "orderr_quickview")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class OrderrQuickview extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "订单之抢答问题观看";
	 ...
	 * @param _this
	 */
	public void makedefault(OrderrQuickview _this){
		_this.gmtCreate=new Date();
		_this.status=0;
		_this.itypePay=0;
		_this.price=0.0;
	}
	public OrderrQuickview(){
		makedefault(this);
	}
	public OrderrQuickview(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public OrderrQuickview(Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,Integer quickId ,String notuse) {
		super();
		this.gmtPay = gmtPay;
		this.status = status;
	...
	* @param notuse String 没用
	 */
	public OrderrQuickview(Integer id ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer quickId ,String title ,Double price ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public OrderrQuickview(Integer id ,Date gmtCreate ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer quickId ,String title ,Double price ,WaJsapiPaymentParam paywxh5 ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof OrderrQuickview == false) return false;
		if(this == obj) return true;
		OrderrQuickview other = (OrderrQuickview)obj;
