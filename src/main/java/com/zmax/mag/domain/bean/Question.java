...
public class Question extends BaseEntity{
	...
	//alias
	public static final String TABLE_ALIAS = "一对一问题";
	...
	public static final String FORMAT_GMT_ANSWER = DATE_FORMAT;
	...
	@DateTimeFormat(pattern = "yyyy-MM-dd HH:mm:ss")
	private Date gmtAnswer;
	/**排列顺序 Integer default=99 数字越小排名越前 */
	@Max(99999999999L)
	
	private Integer priority = 99;
	/**状态 Integer default=0  map={'0':'未支付','1':'已支付','2':'已回答'}*/
	@Max(999L)
	...
	/**回答字数 Integer default=0 计算产生 */
	@Max(99999999999L)
	
	private Integer answerwords = 0;
	...
	/**答案*/
	private QuestionTxt questionTxt;
	//columns END
	/**
	 * 设置默认值
	 * @param _this
	 */
	public void makedefault(Question _this){
	 ...
	 * @param gmtAnswer Date 回答时间   
	 * @param priority Integer 排列顺序 default=99 数字越小排名越前 
	 * @param status Integer 状态 default=0  {'0':'未支付','1':'已支付','2':'已回答'}
	 ...
	 * @param answerwords Integer 回答字数 default=0 计算产生 
	 ...
	 * @param quest String 问题   
	 * @param ctype Integer 评论情况   {'0':'以后再评','1':'好评','-1':'差评'}
	* @param notuse String 没用
	 */
	public Question(Date gmtPay ,Date gmtAnswer ,Integer priority ,Integer status ,Integer ptype ,Integer articlechannelId ,Integer memberQu ,Integer memberAn ,Double viewprice ,Integer answerwords ,Integer viewnum ,Integer goodnum ,Integer badnum ,String title ,String quest ,Integer ctype ,String notuse) {
		super();
		this.gmtPay = gmtPay;
		this.gmtAnswer = gmtAnswer;
	 ...
	 * @param memberQu Integer 提问者 default=0  
	 * @param memberAn Integer 回答者 default=0  
	 * @param price Double 咨询费 default=0.0 取决于回答者 
	 * @param viewprice Double 观看费 default=0.0  
	 * @param answerwords Integer 回答字数 default=0 计算产生 
	 * @param viewnum Integer 观看人数 default=0 计算产生 
	 * @param goodnum Integer 好评人数 default=0 计算产生 
	...
	* @param notuse String 没用
	 */
	public Question(Integer id ,Date gmtModified ,Date gmtPay ,Date gmtAnswer ,Integer priority ,Integer status ,Integer ptype ,Integer articlechannelId ,Integer memberQu ,Integer memberAn ,Double price ,Double viewprice ,Integer answerwords ,Integer viewnum ,Integer goodnum ,Integer badnum ,String title ,String quest ,Integer ctype ,String notuse) {
		super();
		this.id = id;
	 ...
	 * @param questionTxt String 答案   
	* @param notuse String 没用
	 */
	public Question(Integer id ,Date gmtCreate ,Date gmtModified ,Date gmtPay ,Date gmtAnswer ,Integer priority ,Integer status ,Integer ptype ,Integer articlechannelId ,Integer memberQu ,Integer memberAn ,Double price ,Double viewprice ,Integer answerwords ,Integer viewnum ,Integer goodnum ,Integer badnum ,String title ,String quest ,Integer ctype ,boolean canread ,QuestionTxt questionTxt ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	@Column(name = "gmt_answer", unique = false, nullable = true, insertable = true, updatable = true, length = 20)
	public Date getGmtAnswer() {
		return this.gmtAnswer;
	}
	/**设置回答时间  */

	public void setGmtAnswer(Date value) {
		this.gmtAnswer = value;
	}
	/**获取排列顺序 数字越小排名越前 */
	...
	@Column(name = "answerwords", unique = false, nullable = true, insertable = true, updatable = true, length = 11)
	public Integer getAnswerwords() {
		return this.answerwords;
	}
	/**设置回答字数 计算产生 */

	public void setAnswerwords(Integer value) {
		this.answerwords = value;
	}
	/**获取观看人数 计算产生 */
	...
	@Column(name = "quest", unique = false, nullable = true, insertable = true, updatable = true, length = 1000)
	...
	public QuestionTxt getQuestionTxt() {
		return this.questionTxt;
	}
	/**设置答案  */

	public void setQuestionTxt(QuestionTxt value) {
	...
	/**回答时间String*/
	private String gmtAnswerString;
	/**获取回答时间String*/
	@Transient
	
	public String getGmtAnswerString() {
		if(gmtAnswerString==null && gmtAnswer!=null)
			gmtAnswerString=new SimpleDateFormat(DATE_FORMAT).format(gmtAnswer);
		return gmtAnswerString;
	}
	/**设置回答时间String*/
	public void setGmtAnswerString(String value) {
		this.gmtAnswerString=value;
	}
	/**状态String*/
	...
	public String toJsonNotshow1(){
		String[] excludesProperties={"myname","mynameid","gmtCreateString","gmtModifiedString","gmtPayString","gmtAnswerString","statusString","statusMap","ptypeString","ptypeMap","articlechannelIdString","articlechannelIdArticlechannelObj","articlechannelIdStringid","memberQuString","memberQuMemberObj","memberQuStringid","memberAnString","memberAnMemberObj","memberAnStringid","ctypeString","ctypeMap","obj1","obj2","obj3","obj4","obj5","obj1","obj1","obj2","obj2","obj3","obj3","null"};
		String ret=JsonUtilAli.toJSONString(this, null, excludesProperties);
		return ret;
	}
	/**
