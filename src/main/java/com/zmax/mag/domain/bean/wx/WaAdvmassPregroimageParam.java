...
public class WaAdvmassPregroimageParam extends BaseEntity{
	 ...
	 * @param _this
	 */
	public void makedefault(WaAdvmassPregroimageParam _this){
		_this.msgtype="image";
	}
	public WaAdvmassPregroimageParam(){
		makedefault(this);
	}
	/**
	 * 不包括自动变量的构造
	...
	* @param notuse String 没用
	 */
	public WaAdvmassPregroimageParam(String touser ,String msgtype ,String notuse) {
		super();
		this.touser = touser;
	...
	* @param notuse String 没用
	 */
	public WaAdvmassPregroimageParam(String touser ,WaEntityImage image ,String msgtype ,String notuse,Object notuse2) {
		super();
		this.touser = touser;
		this.image = image;
		this.msgtype = msgtype;
...
WaAdvmassPregroimageParam waAdvmassPregroimageParam = new WaAdvmassPregroimageParam(
