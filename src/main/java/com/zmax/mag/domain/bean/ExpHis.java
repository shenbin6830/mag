...
public class ExpHis extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "经验流水";
	...
	/**类型 Integer default=0 对会员来说正是得经验，负是失经验，基本上没负 map={'1':'充值','2':'回答一对一','3':'回答抢答'}*/
	@Max(99999999999L)
	
	private Integer otype = 0;
	/**数量 Integer default=0 1经验=0.1元，有正负，正是得，负是失 */
	@Max(99999999999L)
	 ...
	 * @param _this
	 */
	public void makedefault(ExpHis _this){
	 ...
	 * @param otype Integer 类型 default=0 对会员来说正是得经验，负是失经验，基本上没负 {'1':'充值','2':'回答一对一','3':'回答抢答'}
	 * @param num Integer 数量 default=0 1经验=0.1元，有正负，正是得，负是失 
	 * @param oid Integer 订单的id default=0 根据类型，指向不同的订单表 
	 * @param cmemo String 备注说明   
	* @param notuse String 没用
	 */
	public ExpHis(Integer memberId ,Integer otype ,Integer num ,Integer oid ,String cmemo ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public ExpHis(Integer id ,Integer memberId ,Integer otype ,Integer num ,Integer oid ,String cmemo ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public ExpHis(Integer id ,Date gmtCreate ,Integer memberId ,Integer otype ,Integer num ,Integer oid ,String cmemo ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	/**获取类型 对会员来说正是得经验，负是失经验，基本上没负 {'1':'充值','2':'回答一对一','3':'回答抢答'}*/
	...
	/**设置类型 对会员来说正是得经验，负是失经验，基本上没负 {'1':'充值','2':'回答一对一','3':'回答抢答'}*/

	public void setOtype(Integer value) {
		this.otype = value;
	}
	/**获取数量 1经验=0.1元，有正负，正是得，负是失 */
	...
	public boolean equals(Object obj) {
		if(obj instanceof ExpHis == false) return false;
		if(this == obj) return true;
		ExpHis other = (ExpHis)obj;
