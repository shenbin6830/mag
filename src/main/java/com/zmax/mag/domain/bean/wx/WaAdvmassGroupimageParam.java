...
public class WaAdvmassGroupimageParam extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "根据分组进行群发之图片";
	 ...
	 * @param _this
	 */
	public void makedefault(WaAdvmassGroupimageParam _this){
		_this.msgtype="image";
	}
	public WaAdvmassGroupimageParam(){
		makedefault(this);
	}
	/**
	 * 不包括自动变量的构造
	...
	* @param notuse String 没用
	 */
	public WaAdvmassGroupimageParam(String msgtype ,String notuse) {
		super();
	 ...
	 * @param image String 文本   
	 * @param msgtype String 群发的消息类型 default=image 群发的消息类型，图文消息为mpnews，文本消息为text，语音为voice，音乐为music，图片为image，视频为video 
	* @param notuse String 没用
	 */
	public WaAdvmassGroupimageParam(List<WaAdvmassFilter> filter ,WaEntityImage image ,String msgtype ,String notuse,Object notuse2) {
		super();
		this.filter = filter;
		this.image = image;
		this.msgtype = msgtype;
...
/*
//精简构造 根据分组进行群发之图片
WaAdvmassGroupimageParam waAdvmassGroupimageParam = new WaAdvmassGroupimageParam(
