...
public class Signin extends BaseEntity{
	...
	/**签到者 Integer default=0  */
	@Max(99999999999L)
	
	private Integer memberId = 0;
	/**顺序号 Integer default=1 1到7，循环 */
	@Max(999L)
	 ...
	 * @param _this
	 */
	public void makedefault(Signin _this){
	...
	public Signin(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	 * 精简版构造，在创建提交数据库时应该使用saveCreate
	 * @param memberId Integer 签到者 default=0  
	 * @param sindex Integer 顺序号 default=1 1到7，循环 
	* @param notuse String 没用
	 */
	public Signin(Integer memberId ,Integer sindex ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public Signin(Integer id ,Integer memberId ,Integer sindex ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public Signin(Integer id ,Date gmtCreate ,Integer memberId ,Integer sindex ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	@Column(name = "sindex", unique = false, nullable = true, insertable = true, updatable = true, length = 3)
	public Integer getSindex() {
		return this.sindex;
	}
	/**设置顺序号 1到7，循环 */

	public void setSindex(Integer value) {
		this.sindex = value;
	}
	/**创建时间String*/
	...
	public boolean equals(Object obj) {
		if(obj instanceof Signin == false) return false;
	...
	public String toJsonNotshow1(){
		String[] excludesProperties={"myname","mynameid","gmtCreateString","memberIdString","memberIdMemberObj","memberIdStringid","obj1","obj2","obj3","obj4","obj5","obj1","obj1","obj2","obj2","obj3","obj3","null"};
		String ret=JsonUtilAli.toJSONString(this, null, excludesProperties);
		return ret;
	}
	/**
