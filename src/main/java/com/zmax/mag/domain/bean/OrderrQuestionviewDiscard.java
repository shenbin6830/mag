...
@Entity
@Table(name = "orderr_questionview_discard")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class OrderrQuestionviewDiscard extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "订单之一对一问题观看放弃";
	 ...
	 * @param _this
	 */
	public void makedefault(OrderrQuestionviewDiscard _this){
		_this.gmtCreate=new Date();
		_this.status=0;
		_this.itypePay=0;
		_this.price=0.0;
	}
	public OrderrQuestionviewDiscard(){
		makedefault(this);
	}
	public OrderrQuestionviewDiscard(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public OrderrQuestionviewDiscard(Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,Integer questionId ,String notuse) {
		super();
		this.gmtPay = gmtPay;
		this.status = status;
	...
	* @param notuse String 没用
	 */
	public OrderrQuestionviewDiscard(Integer id ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer questionId ,String title ,Double price ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public OrderrQuestionviewDiscard(Integer id ,Date gmtCreate ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer questionId ,String title ,Double price ,WaJsapiPaymentParam paywxh5 ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof OrderrQuestionviewDiscard == false) return false;
		if(this == obj) return true;
		OrderrQuestionviewDiscard other = (OrderrQuestionviewDiscard)obj;
