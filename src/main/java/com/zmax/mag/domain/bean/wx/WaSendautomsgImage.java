...
public class WaSendautomsgImage extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "被动回复消息之图片";
	 ...
	 * @param _this
	 */
	public void makedefault(WaSendautomsgImage _this){
		_this.msgtype="image";
	}
	public WaSendautomsgImage(){
		makedefault(this);
	}
	/**
	 * 不包括自动变量的构造
	...
	* @param notuse String 没用
	 */
	public WaSendautomsgImage(String tousername ,String fromusername ,Long createtime ,String msgtype ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public WaSendautomsgImage(String tousername ,String fromusername ,Long createtime ,String msgtype ,WaEntityImage image ,String notuse,Object notuse2) {
		super();
		this.tousername = tousername;
		this.fromusername = fromusername;
		this.createtime = createtime;
...
/*
//精简构造 被动回复消息之图片
WaSendautomsgImage waSendautomsgImage = new WaSendautomsgImage(
