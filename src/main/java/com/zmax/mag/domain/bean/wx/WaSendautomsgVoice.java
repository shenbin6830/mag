...
public class WaSendautomsgVoice extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "被动回复消息之语音";
	 ...
	 * @param _this
	 */
	public void makedefault(WaSendautomsgVoice _this){
		_this.msgtype="voice";
	}
	public WaSendautomsgVoice(){
		makedefault(this);
	}
	/**
	 * 不包括自动变量的构造
	...
	* @param notuse String 没用
	 */
	public WaSendautomsgVoice(String tousername ,String fromusername ,Long createtime ,String msgtype ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public WaSendautomsgVoice(String tousername ,String fromusername ,Long createtime ,String msgtype ,WaEntityVoice voice ,String notuse,Object notuse2) {
		super();
		this.tousername = tousername;
		this.fromusername = fromusername;
		this.createtime = createtime;
...
/*
//精简构造 被动回复消息之语音
WaSendautomsgVoice waSendautomsgVoice = new WaSendautomsgVoice(
