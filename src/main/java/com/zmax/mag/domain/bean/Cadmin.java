...
public class Cadmin extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "一般管理员";
	 ...
	 * @param _this
	 */
	public void makedefault(Cadmin _this){
	}
	public Cadmin(){
		makedefault(this);
	}
	public Cadmin(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public Cadmin(String nickname ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public Cadmin(Integer id ,String nickname ,String notuse) {
		super();
		this.id = id;
		this.nickname = nickname;
	}
	...
	* @param notuse String 没用
	 */
	public Cadmin(Integer id ,String nickname ,String notuse,Object notuse2) {
		super();
		this.id = id;
		this.nickname = nickname;
	}
	...
	public boolean equals(Object obj) {
		if(obj instanceof Cadmin == false) return false;
		if(this == obj) return true;
		Cadmin other = (Cadmin)obj;
