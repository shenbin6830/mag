...
@Entity
@Table(name = "orderr_question_discard")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class OrderrQuestionDiscard extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "订单之一对一问题提问放弃";
	 ...
	 * @param _this
	 */
	public void makedefault(OrderrQuestionDiscard _this){
		_this.gmtCreate=new Date();
		_this.status=0;
		_this.itypePay=0;
		_this.price=0.0;
	}
	public OrderrQuestionDiscard(){
		makedefault(this);
	}
	public OrderrQuestionDiscard(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public OrderrQuestionDiscard(Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,Integer questionId ,String notuse) {
		super();
		this.gmtPay = gmtPay;
		this.status = status;
	...
	* @param notuse String 没用
	 */
	public OrderrQuestionDiscard(Integer id ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer questionId ,String title ,Double price ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public OrderrQuestionDiscard(Integer id ,Date gmtCreate ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer questionId ,String title ,Double price ,WaJsapiPaymentParam paywxh5 ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof OrderrQuestionDiscard == false) return false;
		if(this == obj) return true;
		OrderrQuestionDiscard other = (OrderrQuestionDiscard)obj;
