...
@Entity
@Table(name = "orderr_quick_discard")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class OrderrQuickDiscard extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "订单之抢答问题提问放弃";
	 ...
	 * @param _this
	 */
	public void makedefault(OrderrQuickDiscard _this){
		_this.gmtCreate=new Date();
		_this.status=0;
		_this.itypePay=0;
		_this.price=0.0;
	}
	public OrderrQuickDiscard(){
		makedefault(this);
	}
	public OrderrQuickDiscard(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public OrderrQuickDiscard(Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,Integer quickId ,String notuse) {
		super();
		this.gmtPay = gmtPay;
		this.status = status;
	...
	* @param notuse String 没用
	 */
	public OrderrQuickDiscard(Integer id ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer quickId ,String title ,Double price ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public OrderrQuickDiscard(Integer id ,Date gmtCreate ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer quickId ,String title ,Double price ,WaJsapiPaymentParam paywxh5 ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof OrderrQuickDiscard == false) return false;
		if(this == obj) return true;
		OrderrQuickDiscard other = (OrderrQuickDiscard)obj;
