...
public class WaAdvmassPregrotextParam extends BaseEntity{
	 ...
	 * @param _this
	 */
	public void makedefault(WaAdvmassPregrotextParam _this){
		_this.msgtype="text";
	}
	public WaAdvmassPregrotextParam(){
		makedefault(this);
	}
	/**
	 * 不包括自动变量的构造
	...
	* @param notuse String 没用
	 */
	public WaAdvmassPregrotextParam(String touser ,String msgtype ,String notuse) {
		super();
		this.touser = touser;
	...
	* @param notuse String 没用
	 */
	public WaAdvmassPregrotextParam(String touser ,WaEntityText text1 ,String msgtype ,String notuse,Object notuse2) {
		super();
		this.touser = touser;
		this.text1 = text1;
		this.msgtype = msgtype;
...
WaAdvmassPregrotextParam waAdvmassPregrotextParam = new WaAdvmassPregrotextParam(
