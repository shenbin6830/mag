...
public class WaSubButton extends BaseEntity{
	 ...
	 * @param _this
	 */
	public void makedefault(WaSubButton _this){
	}
	public WaSubButton(){
		makedefault(this);
	}
	public WaSubButton(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public WaSubButton(String type ,String name ,String key1 ,String url ,String mediaId ,String notuse) {
		super();
		this.type = type;
		this.name = name;
		this.key1 = key1;
	...
	* @param notuse String 没用
	 */
	public WaSubButton(Integer id ,String type ,String name ,String key1 ,String url ,String mediaId ,String notuse) {
		super();
		this.id = id;
		this.type = type;
		this.name = name;
	...
	* @param notuse String 没用
	 */
	public WaSubButton(Integer id ,String type ,String name ,String key1 ,String url ,String mediaId ,String notuse,Object notuse2) {
		super();
		this.id = id;
		this.type = type;
		this.name = name;
	...
	* @param notuse String 没用
	 */
	public WaSubButton(Integer _id,String _type,String notuse){
		this.type=_type;
		makedefault(this);
	}
...
/*
//精简构造 用户分组
WaSubButton waSubButton = new WaSubButton(
