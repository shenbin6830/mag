...
@Entity
@Table(name = "orderr_quick")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class OrderrQuick extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "订单之抢答问题提问";
	 ...
	 * @param _this
	 */
	public void makedefault(OrderrQuick _this){
	...
	public OrderrQuick(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public OrderrQuick(Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,Integer quickId ,String notuse) {
		super();
		this.gmtPay = gmtPay;
		this.status = status;
	...
	* @param notuse String 没用
	 */
	public OrderrQuick(Integer id ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer quickId ,String title ,Double price ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public OrderrQuick(Integer id ,Date gmtCreate ,Date gmtPay ,Integer status ,Integer itypePay ,Integer memberId ,String name ,String mobile ,Integer quickId ,String title ,Double price ,WaJsapiPaymentParam paywxh5 ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof OrderrQuick == false) return false;
		if(this == obj) return true;
		OrderrQuick other = (OrderrQuick)obj;
