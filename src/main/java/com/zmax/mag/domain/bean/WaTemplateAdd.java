...
/**
 * 模板消息接口之获得模板ID<br/>根据idshort获取id
 * @author zmax
 * @version 1.0
 * @since 
 */
...
@Entity
@Table(name = "wa_template_add")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class WaTemplateAdd extends BaseResult{
	
	//alias
	public static final String TABLE_ALIAS = "模板消息接口之获得模板ID";
	...
	/**状态 Integer default=1 有效的不超过15个 */
	@Max(999L)
	 ...
	 * @param _this
	 */
	public void makedefault(WaTemplateAdd _this){
		_this.statusValidOrNot=1;
	}
	public WaTemplateAdd(){
		makedefault(this);
	}
	public WaTemplateAdd(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	 ...
	 * @param statusValidOrNot Integer 状态 default=1 有效的不超过15个 
	 * @param templateIdShort String 模板短编号  模板库中模板的编号，有“TM**”和“OPENTMTM**”等形式 
	 * @param templateId String 模板id   
	* @param notuse String 没用
	 */
	public WaTemplateAdd(Integer userId ,Integer statusValidOrNot ,String templateIdShort ,String templateId ,String notuse) {
		super();
		this.userId = userId;
	...
	* @param notuse String 没用
	 */
	public WaTemplateAdd(Integer id ,Integer userId ,Integer statusValidOrNot ,String templateIdShort ,String templateId ,String notuse) {
		super();
		this.id = id;
		this.userId = userId;
		this.statusValidOrNot = statusValidOrNot;
	...
	* @param notuse String 没用
	 */
	public WaTemplateAdd(Integer id ,Integer userId ,Integer statusValidOrNot ,String templateIdShort ,String templateId ,String notuse,Object notuse2) {
		super();
		this.id = id;
		this.userId = userId;
		this.statusValidOrNot = statusValidOrNot;
...
@JSONField(name="name")
	...
	public boolean equals(Object obj) {
		if(obj instanceof WaTemplateAdd == false) return false;
		if(this == obj) return true;
		WaTemplateAdd other = (WaTemplateAdd)obj;
