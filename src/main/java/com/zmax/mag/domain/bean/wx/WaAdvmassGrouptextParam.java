...
public class WaAdvmassGrouptextParam extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "根据分组进行群发之文本";
	 ...
	 * @param _this
	 */
	public void makedefault(WaAdvmassGrouptextParam _this){
		_this.msgtype="text";
	}
	public WaAdvmassGrouptextParam(){
		makedefault(this);
	}
	/**
	 * 不包括自动变量的构造
	...
	* @param notuse String 没用
	 */
	public WaAdvmassGrouptextParam(String msgtype ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public WaAdvmassGrouptextParam(List<WaAdvmassFilter> filter ,WaEntityText text1 ,String msgtype ,String notuse,Object notuse2) {
		super();
		this.filter = filter;
		this.text1 = text1;
		this.msgtype = msgtype;
...
/*
//精简构造 根据分组进行群发之文本
WaAdvmassGrouptextParam waAdvmassGrouptextParam = new WaAdvmassGrouptextParam(
