...
@Entity
@Table(name = "expmember_stati_day")
@Cache(usage=CacheConcurrencyStrategy.READ_WRITE)//可读可写
public class ExpmemberStatiDay extends BaseEntity{
	
	//alias
	public static final String TABLE_ALIAS = "会员经验日统计";
	 ...
	 * @param _this
	 */
	public void makedefault(ExpmemberStatiDay _this){
		_this.gmtCreate=new Date();
		_this.num=0;
		_this.nstart=0;
		_this.nend=0;
	}
	public ExpmemberStatiDay(){
		makedefault(this);
	}
	public ExpmemberStatiDay(Integer _id){
		this.id=_id;
		makedefault(this);
	}
	/**
	...
	* @param notuse String 没用
	 */
	public ExpmemberStatiDay(Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse) {
		super();
	...
	* @param notuse String 没用
	 */
	public ExpmemberStatiDay(Integer id ,Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse) {
		super();
		this.id = id;
	...
	* @param notuse String 没用
	 */
	public ExpmemberStatiDay(Integer id ,Date gmtCreate ,Date gmtStati ,Integer memberId ,Integer num ,Integer nstart ,Integer nend ,String cmemo ,String notuse,Object notuse2) {
		super();
		this.id = id;
	...
	public boolean equals(Object obj) {
		if(obj instanceof ExpmemberStatiDay == false) return false;
		if(this == obj) return true;
		ExpmemberStatiDay other = (ExpmemberStatiDay)obj;
