...
public abstract class Command {
	 ...
	 */
	protected ZresConfiguration configuration;
	...
	protected boolean checkIfCurrFolderExists(final HttpServletRequest request)
		...
		if (tmpType != null) {
			File currDir = new File(
					configuration.getTypes().get(tmpType).getPath(request)
					+ this.currentFolder);
	 ...
	 */
	public abstract void execute(final HttpServletRequest request,final OutputStream out)
			throws ConnectorException;
