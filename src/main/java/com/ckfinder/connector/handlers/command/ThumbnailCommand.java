...
public class ThumbnailCommand extends Command {
	...
	public void setResponseHeader(final HttpServletResponse response) {
		...
		String mimetype = getMimeTypeOfImage(response);
	 ...
	 */
	private String getMimeTypeOfImage(final HttpServletResponse response) {
	 ...
	 *             if validation fails.
	 */
	private void validate(final HttpServletRequest request) throws ConnectorException {
		...
		File typeThumbDir = new File(configuration.getThumbsDir(request)
				+ File.separator + type);
	 ...
	 *             when error occurs.
	 */
	private void createThumb(final HttpServletRequest request) throws ConnectorException {
