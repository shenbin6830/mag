...
public class FileUtils {
	 ...
	 */
	public static String getFullPath(final String file,ServletContext servletContext) throws Exception {
	 ...
	 * @throws IOException when io error occurs.
	 */
	public static void createPath(final File file, final ZresConfiguration conf,
	 ...
	 */
	public static Boolean hasChildren( String dirPath, File dir, ZresConfiguration configuration, String resourceType, String currentUserRole )
	{
	...
	public static boolean checkFolderName( final String folderName, final ZresConfiguration configuration )
	{
	...
	public static boolean checkFileName( final String fileName, final ZresConfiguration configuration ){
