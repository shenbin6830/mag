...
public final class AccessControlUtil {
	 ...
	 */
	private ZresConfiguration configuration;
	/**
	 * current instance.
	 */
	 ...
	 */
	public static AccessControlUtil getInstance(final ZresConfiguration configuration1) {
		if (util == null) {
	 ...
	 * @param configuration1 connector configuration
	 */
	private AccessControlUtil(final ZresConfiguration configuration1) {
	 ...
	 * @return acl value
	 */
	public int checkACLForRole1(final String resourceType, final String folder,
								final String currentUserRole) {
		CheckEntry[] ce = new CheckEntry[
									 currentUserRole != null ? 4 : 2];
