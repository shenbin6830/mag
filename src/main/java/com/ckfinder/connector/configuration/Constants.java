...
public class Constants {
	...
	/**根物理路径，需要在启动时赋值 ex. d:/tomcat/webapps/zecms/userfiles */
	public static  String BASE_DIR = "d:/tomcat/webapps/zecms/userfiles";
	/**根URL路径，需要在启动时赋值 ex. /zecms/userfiles */
	public static  String BASE_URL = "/zecms/userfiles";
	/**
	 * Error codes.
	 */
