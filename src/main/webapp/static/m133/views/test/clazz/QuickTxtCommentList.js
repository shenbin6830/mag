 ...
 */
app.controller('QuickTxtCommentListCtrl', function ($scope,$log,$state,$location,Storage,ENV,CommonService,QuickTxtCommentService) {
    ...
    $scope.first=function(){
        QuickTxtCommentService.first(null,$scope.page).then(function (data) {
