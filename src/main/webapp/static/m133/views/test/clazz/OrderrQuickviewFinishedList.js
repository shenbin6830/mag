 ...
 */
app.controller('OrderrQuickviewFinishedListCtrl', function ($scope,$log,$state,$location,Storage,ENV,CommonService,OrderrQuickviewFinishedService) {
    ...
    $scope.first=function(){
        OrderrQuickviewFinishedService.first(null,$scope.page).then(function (data) {
