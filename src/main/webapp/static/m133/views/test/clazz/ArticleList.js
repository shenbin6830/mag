 ...
 */
app.controller('ArticleListCtrl', function ($scope,$log,$state,$location,Storage,ENV,CommonService,ArticleService) {
    ...
    $scope.first=function(){
        ArticleService.first(null,$scope.page).then(function (data) {
