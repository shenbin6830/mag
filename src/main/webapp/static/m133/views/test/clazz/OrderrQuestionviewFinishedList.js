 ...
 */
app.controller('OrderrQuestionviewFinishedListCtrl', function ($scope,$log,$state,$location,Storage,ENV,CommonService,OrderrQuestionviewFinishedService) {
    ...
    $scope.first=function(){
        OrderrQuestionviewFinishedService.first(null,$scope.page).then(function (data) {
