 ...
 */
app.controller('MemberRelationListCtrl', function ($scope,$log,$state,$location,Storage,ENV,CommonService,MemberRelationService) {
    ...
    $scope.first=function(){
        MemberRelationService.first(null,$scope.page).then(function (data) {
