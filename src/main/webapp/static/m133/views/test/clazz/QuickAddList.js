 ...
 */
app.controller('QuickAddListCtrl', function ($scope,$log,$state,$location,Storage,ENV,CommonService,QuickAddService) {
    ...
    $scope.first=function(){
        QuickAddService.first(null,$scope.page).then(function (data) {
