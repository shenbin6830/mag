 ...
 */
app.controller('QuestionAddListCtrl', function ($scope,$log,$state,$location,Storage,ENV,CommonService,QuestionAddService) {
    ...
    $scope.first=function(){
        QuestionAddService.first(null,$scope.page).then(function (data) {
