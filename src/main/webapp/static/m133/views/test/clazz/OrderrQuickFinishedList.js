 ...
 */
app.controller('OrderrQuickFinishedListCtrl', function ($scope,$log,$state,$location,Storage,ENV,CommonService,OrderrQuickFinishedService) {
    ...
    $scope.first=function(){
        OrderrQuickFinishedService.first(null,$scope.page).then(function (data) {
