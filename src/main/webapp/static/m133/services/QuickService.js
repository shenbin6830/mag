 ...
 */
app
    .service('QuickService', function($rootScope,$q,$http,$log,ENV) {
        ...
        return {
             ...
             * @param _page 页码对象，如果为空使用全局页码对象
             */
            create: function(Quick,_page) {
                var thispage=(_page)?_page:_Page;
                var tmpparam=_.omit(Quick, function(value, key, object) {
