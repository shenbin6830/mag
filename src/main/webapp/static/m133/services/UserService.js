 ...
 */
app
    .service('UserService', function($rootScope,$q,$http,$log,ENV) {
        ...
        return {
             ...
             * @param _page 页码对象，如果为空使用全局页码对象
             */
            create: function(User,_page) {
                var thispage=(_page)?_page:_Page;
                var tmpparam=_.omit(User, function(value, key, object) {
