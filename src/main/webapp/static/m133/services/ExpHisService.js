 ...
 */
app
    .service('ExpHisService', function($rootScope,$q,$http,$log,ENV) {
        ...
        return {
			...
			/**
             * 创建Promise版
             * @param ExpHis 要被创建的对象
             * @param _page 页码对象，如果为空使用全局页码对象
             */
            create: function(ExpHis,_page) {
                var thispage=(_page)?_page:_Page;
                var tmpparam=_.omit(ExpHis, function(value, key, object) {
            ...
            /**
             * 更新Promise版
             * @param ExpHis 要被更新的对象
             * @param _page 页码对象，如果为空使用全局页码对象
             */
            update: function(ExpHis,_page) {
                var thispage=(_page)?_page:_Page;
                var tmpparam=_.omit(ExpHis, function(value, key, object) {
                    return _.isObject(value) || _.isArray(value)
                        || key.indexOf("String") != -1 || key.indexOf("gmt") != -1
