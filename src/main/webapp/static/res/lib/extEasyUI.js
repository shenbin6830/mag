...
/**
 * EasyUI 自建格式化工具
 *  <th field="Date" formatter="MyFormatter.DateFormatter" width="80">日期</th>
 *  <th field="Date" formatter="MyFormatter.TitleCut12" width="100">标题</th>
 *  {field : 'quest',title : '问题',width : 300 ,formatter:MyFormatter.TitleCut12 }
 */
var MyFormatter = {
	    ...
	    TitleCut12: function (value, rec, index) {
	        if (value.length > 12) value = value.substr(0, 9) + "...";
	        return value;
	    },
	    TitleCut15: function (value, rec, index) {
	        if (value.length > 15) value = value.substr(0, 12) + "...";
	        return value;
	    },
	    TitleCut18: function (value, rec, index) {
	        if (value.length > 18) value = value.substr(0, 15) + "...";
	        return value;
	    }
	};